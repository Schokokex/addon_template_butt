...
function SETMAXLEVEL(level)
	MAX_LEVEL = level
	USE_CUSTOM_HERO_LEVELS = (level~=25)					
	USE_CUSTOM_XP_VALUES = (level~=25)
	XP_PER_LEVEL_TABLE = {
		0,
		240,
		600,
		...
		25105,
		27800,
	} for i = #XP_PER_LEVEL_TABLE + 1, MAX_LEVEL do XP_PER_LEVEL_TABLE[i] = XP_PER_LEVEL_TABLE[i - 1] + (300 * ( i - 15 )) end
